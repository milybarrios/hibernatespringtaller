...
import py.edu.facitec.hibernatespringtaller.controller.PedidoController;
...
@EnableWebMvc
@ComponentScan(basePackageClasses={HomeController.class,ClienteDAO.class,ProductoDAO.class,PedidoDAO.class})
...
public ViewResolver contentNegotiatingViewResolver(
	...
	resolvers.add(new JsonViewResolver());//Clase creada para manipular JSON
